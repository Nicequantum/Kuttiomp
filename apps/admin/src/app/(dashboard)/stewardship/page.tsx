  ...
  return (
    <>
      ...
      <div className="space-y-6 p-6 md:p-8">
        <ContinuityPanelLive />
        <p
          className="mode-content-text max-w-3xl text-muted-foreground"
        >
          Apply{" "}
          ...
          so live RPCs{" "}
          <code className="rounded bg-muted px-1">speaker_stewardship_summary</code> and{" "}
          <code className="rounded bg-muted px-1">corpus_continuity_metrics</code> are
          ...
          See <code className="rounded bg-muted px-1">docs/MIGRATION_005_APPLY.md</code>.
          Switch portal visual path in the sidebar to preview Elder vs Core Adult
          presentation of these absolute counts.
        </p>
      </div>
    </>
  );
