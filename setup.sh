...
# Narragansett Language Revitalization Platform v0.3
...
echo "  Narragansett Language Revitalization Platform"
echo "═══════════════════════════════════════════════════════════"
echo ""
...
echo ""
echo "⚠  Edit .env files with your Supabase, Clerk, and xAI credentials."
echo ""
